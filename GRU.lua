...
function GRU:migrate(params)
   ...
   _params[1]:copy(params[1]:narrow(1,1,2400))
   _params[2]:copy(params[2]:narrow(1,1,2400))
   _params[3]:copy(params[1]:narrow(1,2401,2400))
   _params[4]:copy(params[2]:narrow(1,2401,2400))
   _params[5]:copy(params[3]:narrow(1,1,2400))
   _params[6]:copy(params[3]:narrow(1,2401,2400))
